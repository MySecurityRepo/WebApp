...
async function resendVerificationEmail(){
  ...
  try {
    ...
    if (message === 'USER_ALREADY_ACTIVE') {
      text = t('resendmailvue.user_already_active')
...
<div class=" container-fluid mt-3">
  <h2 class="text-warning fw-bold">{{ t('resendmailvue.header') }}</h2>
  ...
  <div class="row mt-5"> 
    ...
    <div class="col mx-auto">
      <div class="container-fluid ">
        ...
        <form method="POST" @submit.prevent="resendVerificationEmail" id=form_reg autocomplete="off" novalidate class="needs-validation w-100 mx-lg-auto my-auto mb-3 w-md-75 form-registration-small">
          <div class="mb-3">
            <b><label class="form-label text-warning fw-bold registration-labels" for="email">{{ t('registrationvue.email') }}</label></b>
